...
def get_model():
    ...
    for _filter in get_config("model.conv_filters"):
        x1 = keras.layers.Conv2D(_filter, get_config("modle.kernel"), padding="same")(x1)
        x1 = keras.layers.BatchNormalization()(x1)
        x1 = keras.layers.Dropout(get_config("model.dropout_rate"))(x1)
        x2 = keras.layers.Conv2D(_filter, get_config("modle.kernel"), padding="same")(x2)
    ...
    y = x2 - x1
    y = keras.layers.Dense(1, activation="tanh")
